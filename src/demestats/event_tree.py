...
import demestats.events
from demestats.rescale import rescale_demo
...
class EventTree:
    ...
    See Also
    --------
    demestats.event_tree.EventTree.variable_for
    ...
    def __init__(
        self,
        demo: demes.Graph,
        events: ModuleType = demestats.events,
    ...
    def _merge_nodes(
        self, x: Node, y: Node, t: Path, event: demestats.events.Event, rm=None
    ) -> Node:
