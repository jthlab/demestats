...
class ICRCurve:
    ...
    See Also
    --------
    demestats.icr.ICRCurve.__call__
    ...
    def nd_or_dn(self) -> ModuleType:
        if os.environ.get("DEMESTATS_FORCE_ICR") == "ND":
            return nd
        elif os.environ.get("DEMESTATS_FORCE_ICR") == "DN":
            return dn
...
def _call(
    ...
    """Call the ICR curve with a time and number of samples."""
    states = {}
...
from .mf import ICRMeanFieldCurve

__all__ = ["ICRCurve", "ICRMeanFieldCurve"]
