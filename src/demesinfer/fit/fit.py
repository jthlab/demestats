...
from demesinfer.loglik import loglik_dbg
...
def fit_avg(
    ...
    *,
    ...
    def neg_loglik(vec):
        ...
        jax.debug.print("cfg_keys: {}", cfg_keys)
        eta_stack = jax.vmap(build_eta)(cfg_keys)
        assert jnp.all(jnp.isfinite(eta_stack)), eta_stack
        jax.debug.print("eta_stack: {}", eta_stack) 
